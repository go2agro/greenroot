      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-[#f5f7f6] px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-10">
            ...
            <h1 className="text-3xl font-bold text-[#191c1c] mb-2">Welcome!</h1>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="flex justify-end">
              <Link href="/forgot-password" className="text-sm text-[#006e1c] hover:text-[#005a17] font-medium">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-6 text-center text-[#191c1c]/60">
            {userType === 'student' ? (
              <>
                ...
                <Link href="/signup" className="text-[#006e1c] font-semibold hover:text-[#005a17]">
                  Create an account.
                </Link>
              </>
            ) : (
              <>
                Don&apos;t have the admin access?{' '}
                <Link href="/contact" className="text-[#006e1c] font-semibold hover:text-[#005a17]">
                  Contact us.
                </Link>
              </>
            )}
